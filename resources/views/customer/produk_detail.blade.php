            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 ">
                    <div class="mt-shop-details__right-warp mb-10 p-relative">
                        ...
                        {{-- Saran & Kritik --}}
                        <div class="mt-shop-details__product-box mt-20">
                            <div class="mt-shop-details__product-box-item">
                                <div class="mt-shop-details__product-box-text">

                                    <h3 class="mt-content-tab-title mb-10">Saran & Kritik</h3>
                                    ...
                                    @else
                                        <div class="alert alert-warning mt-3">
                                            Silakan <a href="{{ route('customer.login') }}">login</a> untuk mengirim saran &
                                            kritik.
                                        </div>
                                    @endauth
                                </div>
                        ...
                        {{-- Daftar Saran & Kritik --}}
                        <div class="mt-shop-details__product-box mt-30">
                            <div class="mt-shop-details__product-box-item">
                                <div class="mt-shop-details__product-box-text">

                                    <h3 class="mt-content-tab-title mb-10">Ulasan Customer</h3>
                                    ...
                                    @forelse ($feedback as $item)
                                        <div class="border p-3 rounded mb-3">
                                            ...
                                            <p class="mt-2 mb-1">{{ $item->pesan }}</p>
                                    ...
                                    @empty
                                        <p class="text-muted">Belum ada saran & kritik.</p>
                                    @endforelse
